      ...
      >
        ...
        <View style={{ alignItems: 'center' }}>
          ...
          <View style={{ height: 22 * tmpWidth, justifyContent: 'center' }}>
            {state.errorMessage ? (
              <Text style={{ color: 'red', fontSize: 12 * tmpWidth }}>{state.errorMessage}</Text>
            ) : null}
          </View>
          <View
            style={{
          ...
          >
            <Text style={{ fontSize: 12 * tmpWidth, color: 'rgb(169,193,255)' }}>
              아이디 / 비밀번호 찾기
            </Text>
          </View>
          <View
      ...
      <View style={styles.footer}>
        <View style={{ flexDirection: 'row', marginTop: 24 * tmpWidth }}>
          ...
          <TouchableOpacity onPress={() => navigate('Signupopt')}>
            <View
              style={{ borderBottomWidth: 1 * tmpWidth, borderBottomColor: 'rgb(168,192,239)' }}
            >
