  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'rgb(255,255,255)' }}>
      ...
      <ScrollView>
        ...
        <View
          style={{ paddingLeft: 24 * tmpWidth, marginTop: 20 * tmpWidth, height: 105 * tmpWidth }}
        >
        ...
        <View style={{ paddingLeft: 24 * tmpWidth }}>
          <View style={{ flexDirection: 'row', marginTop: 55 * tmpWidth }}>
            {agreeall ? (
              <TouchableOpacity
                style={agreeall ? styles.boxcheck : styles.boxempty}
                onPress={() => {
                  setAgreeall(false);
                  setAgree1(false);
                  setAgree2(false);
              ...
              >
                <SvgUri
                  width="100%"
                  height="100%"
                  source={require('assets/icons/invalidName.svg')}
                />
              </TouchableOpacity>
            ) : (
              <TouchableOpacity
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              {agree1 ? (
                <TouchableOpacity
                  style={agree1 ? styles.boxcheck : styles.boxempty}
                  onPress={() => {
                    setAgree1(false);
                  }}
                >
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              {agree2 ? (
                <TouchableOpacity
                  style={agree2 ? styles.boxcheck : styles.boxempty}
                  onPress={() => {
                    setAgree2(false);
                  }}
                >
          ...
          <View style={styles.modalbox}>
            <View style={{ width: 335 * tmpWidth, height: 56 * tmpWidth, flexDirection: 'row' }}>
              ...
              {songs.length >= 1 ? (
                ...
                >
                  <Text style={{ fontSize: 16 * tmpWidth, color: 'rgba(169,193,255,1)' }}>
                    완료
                  </Text>
                </TouchableOpacity>
              ) : null}
            ...
            >
              ...
              >
                <SvgUri
                  width="100%"
                  height="100%"
                  source={require('assets/icons/signupsearch.svg')}
                />
              </View>
              <TextInput
                style={{ fontSize: 16 * tmpWidth, width: tmpWidth * 230 }}
                value={text}
