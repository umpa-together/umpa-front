...
const DailySearchSongPage = ({  route}) => {
    ...
    const { data: addedplayList, isEdit } = route.params
        ...
        <View style={styles.container}>
             <View style={{width: '100%'}}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>데일리 만들기</Text>
                </View>
            </View>
            <View style={styles.searchBox}>
                <View style ={{ flexDirection:'row', justifyContent: 'space-between', alignItems: 'center'}}>
                    <View style={{flexDirection: 'row', alignItems: 'center', marginLeft: 14 * tmpWidth}}>
                        <SvgUri width='40' height='40' source={require('../../assets/icons/playlistSearch.png')}/>
            ...
            <View style={styles.selectedBox}>
                <View style={styles.selectedBoxHeader}>
                    ...
                    <TouchableOpacity onPress={async () => {
                        ...
                        navigate('CreateDaily', { data:songs, isEdit })}}>
...
DailySearchSongPage.navigationOptions = ()=>{
    return {
        headerShown: false    
    };
};
...
export default DailySearchSongPage;