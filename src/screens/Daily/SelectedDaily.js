...
const SelectedDaily = ({navigation}) => {
    ...
    const Dailyid= navigation.getParam('id');
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{flex: 1}}>
                ...
                <Image style={styles.thumbnail} source={{uri: currentDaily.image}}/>
                <View style={styles.header}>
                    ...
                    { deleteModal ? <DeleteModal navigation={navigation} deleteModal={deleteModal} setDeleteModal={setDeleteModal} type={'Daily'} /> : null }
                    ...
                    <View style={styles.profileBox}>
                        <TouchableOpacity onPress={async () => {
                            if(currentDaily.postUserId._id == userState.myInfo._id){
                                ...
                                navigation.push('OtherAccount', {otherUserId:currentDaily.postUserId._id}); }}}>
                        ...
                        <View style={styles.profileTextBox}>
                            ...
                            <View style={styles.viewContainer}>
                                ...
                                <Text style={{fontSize: 12 * tmpWidth, color: 'rgb(255,255,255)'}}>{currentDaily.views}</Text>
                                <SvgUri width='24' height='24' source={require('../../assets/icons/playlistMiniHeart.svg')} />
                                <Text style={{fontSize: 12 * tmpWidth, color: 'rgb(255,255,255)'}}>{currentDaily.likes.length}</Text>
                            </View>
                        </View>
                                ...
                                <TouchableOpacity style={styles.commentBox} key={item._id} onPress={ async()=> {
                                    ...
                                    <View>
                                        ...
                                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                            ...
                                            { commentDeleteModal ? <DeleteModal navigation={navigation} deleteModal={commentDeleteModal} setDeleteModal={setCommentDeleteModal} type={'dailyComment'} subjectId={deleteId} setComments={setComments} dailyId={Dailyid}/> : null }
                                        </View>
                                    </View>
                                    {showModal == item._id ?
                                    <Modal
                                                        ...
                                                        <View style={styles.commentBox}>
                                                            ...
                                                            <View >
                                                                ...
                                                                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                                                    ...
                                                                    { reCommentDeleteModal ? <DeleteModal navigation={navigation} deleteModal={reCommentDeleteModal} setDeleteModal={setReCommentDeleteModal} type={'dailyReComment'} subjectId={deleteId}/> : null }
                                                                </View>
                                                            </View>
                                                        </View>
                                                    )
            ...
            { deletedModal ? <DeletedModal navigation={navigation} deletedModal={deletedModal} setDeletedModal={setDeletedModal} type={"Daily"}/> : null}
        </View>
    );
};
