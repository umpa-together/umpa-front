...
export default RecommentTarget = () => {
    ...
    const { currentComment, onClickProfile, onClickCommentLikes } = useDaily()
    ...
    const { postUserId: postUser, time, text, likes, recomments, _id: id, dailyId } = currentComment
        ...
        <View style={styles.container}>
            ...
            <View style={styles.contentBox}>
                ...
                <View style={styles.flexRow}>
                    ...
                    { commentDeleteModal && <DeleteModal deleteModal={commentDeleteModal} setDeleteModal={setCommentDeleteModal} type={'playlistComment'} subjectId={id} dailyId={dailyId}/> }
                </View>
            </View>
        </View>
    )
