    ...
    return (
        ...
        >
            ...
            <TouchableOpacity 
                ...
                style={[styles.box, styles.add, styles.column, 
                    songs.length !== 0 && styles.active, !validity.song && styles.warningBorder]}
            >
                <SvgUri 
                    width='40' height='40' 
                    source={songs.length === 0 ? require('assets/icons/addSong.svg') : require('assets/icons/editSong.svg')} 
                    style={styles.icon} 
                />
                <Text 
                    style={[songs.length === 0 ? styles.text : styles.activeText, !validity.song && styles.warning]}
                >
            ...
            {images.map((item) => {
                ...
                return (
                    <TouchableOpacity 
                        onPress={() => onClickPhoto(item.node.image)}
                        key={img}
                    >
