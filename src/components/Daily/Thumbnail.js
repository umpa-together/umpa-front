        ...
        <View style={{ height: tmpWidth * 60 }}>
          <TouchableOpacity style={styles.back} onPress={goBack}>
            <SvgUri
              width={40 * tmpWidth}
              height={40 * tmpWidth}
              source={require('assets/icons/playlistBack.svg')}
            />
          </TouchableOpacity>
        </View>
      ) : (
                  ...
                  >
                    <TouchableOpacity style={styles.modalExit} onPress={onClose}>
                      <SvgUri
                        width={40}
                        height={40}
                        source={require('assets/icons/modalexit.svg')}
                      />
                    </TouchableOpacity>
                    <Image source={{ uri: imgzoom }} style={styles.modalImg} resizeMode="contain" />
                  </Modal>
                </View>
              )}
            />
