...
const AddedSongLists = ({ addedSongs }) => {
  const { setSongs, songs, onClickDeleteSong, validity } = useDaily();
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.flexRow}>
        <Text style={styles.title}>담은 곡</Text>
        <Text style={validity.song ? styles.subTitle : styles.warning}>(1곡)</Text>
      </View>
      <FlatList
        horizontal
          ...
          return (
            <View style={styles.box}>
              <TouchableOpacity onPress={() => onClickCover(item)}>
                ...
                <TouchableOpacity onPress={() => onClickDeleteSong(item)} style={styles.deleteIcon}>
                  <SvgUri
                    width="15"
                    height="15"
                    source={require('assets/icons/addedSongDelete.svg')}
                  />
                </TouchableOpacity>
                <SvgUri
                  width="24"
