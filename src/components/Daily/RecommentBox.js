...
export default RecommentBox = ({ recomments }) => {
    const { likesrecomment, unlikesrecomment } = useContext(DailyContext);
    ...
    const { onClickProfile, currentComment } = useDaily()
        ...
        <View style={styles.commentBox}>
            ...
            <View style={styles.contentBox}>
                ...
                <View style={styles.flexRow}>
                    ...
                    { commentReportModal && <ReportModal reportModal={commentReportModal} setReportModal={setCommentReportModal} type={'dailyReComment'} subjectId={id} /> }
                    { reCommentDeleteModal && <DeleteModal deleteModal={reCommentDeleteModal} setDeleteModal={setReCommentDeleteModal} type={'dailyReComment'} subjectId={id}/> }
                </View>
            </View>
        </View>
    )
