                ...
                <View style={styles.flexRow}>
                  ...
                  <View style={styles.flexRow}>
                    {playlists.slice(0, 3).map((playlist) => {
                      ...
                      return (
                        <TouchableOpacity
                          onPress={() => onClickPlaylist(playlist)}
                    ...
                    {length > 0 &&
                      [...Array(length)].map(() => (
                        <View style={[styles.songmargin, styles.playlistImg]} key={Math.random()} />
                      ))}
                  </View>
                </View>
                <View style={styles.spaceBetween}>
                  ...
                  >
                    {isFollow.includes(id) ? (
                      ...
                      <Text style={styles.following}>팔로우</Text>
                    )}
                  </TouchableOpacity>
                </View>
              </View>
