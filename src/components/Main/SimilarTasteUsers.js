...
export default SimilarTasteUsers = ({ users }) => {
    ...
    const { addtracksong, isPlayingId } = useTrackPlayer()
    ...
    return (
        <View>
                ...
                renderItem={({item}) => {
                    ...
                    return (
                        <View style={styles.box}>
                            <TouchableOpacity 
                                onPress={() => onClickRepresent(songs)}
                                style={styles.songImg}
                            >
                                <SongImage url={songs[0].attributes.artwork.url} size={80} border={80}/>
                                <SvgUri width='30' height='30' source={require('assets/icons/modalPlay.svg')} style={styles.play}/>
                            </TouchableOpacity>
            ...
            /> }
            <RepresentSong representModal={representModal} setRepresentModal={setRepresentModal} song={currentSong} myAccount={false}/>
        </View>
    )   
}
