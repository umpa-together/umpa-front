...
const PlaylistsLikes = ({ playlist }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.flexRow}>
        <TouchableOpacity onPress={() => SendList({ playlist })}>
      ...
      {deleteModal && (
        <DeleteModal deleteModal={deleteModal} setDeleteModal={setDeleteModal} type="playlist" />
      )}
      {reportModal && (
        <ReportModal
