...
const CommentBox = ({ comment }) => {
  ...
  const { postUserId: postUser, time, text, likes, recomments, _id: id, playlistId } = comment;
  ...
  const { onClickComment, onClickProfile, onClickCommentLikes } = usePlaylist();
    ...
    <TouchableOpacity style={styles.container} onPress={() => onClickComments(comment)}>
      ...
      <View style={styles.contentBox}>
        ...
        <View style={styles.contentFooter}>
          <TouchableOpacity onPress={() => onClickCommentLikes(likes, playlistId, id)}>
            <Text
