...
export default function TosForm() {
  return (
    ...
    >
      ...
      <Text style={styles.top}>
        4. 회사가 본 조 제 3항에 따라 변경 약관을 공지 또는 통지하면서, 회원에게 약관 변경
        적용일까지 거부의사를 표시하지 아니하는 경우 약관의 변경의 동의한 것으로 간주한다는 내용을
        명확하게 공지 또는 통지하였음에도 회원이 변경된 약간의 효력 발생일까지 약관변경에 대한
        명시적인 거부의 의사를 표시하지 아니하면 회원이 변경 약관에 동의한 것으로 간주합니다.
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        ...
        동의한 후 서비스 회원번호 보유하고 umpa 아이디(ID)와 비밀번호(PASSWORD)를 발급 받아
        웹,모바일 등의 모든 채널의 서비스를 이용 가능한 고객
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.title}>제 2 장 서비스 이용 계약</Text>
      <Text style={styles.title}>제 5 조(이용 계약의 성립)</Text>
      <Text style={styles.top}>
        1. 약관, 서비스 상품약관 및 개인정보 수집 및 이용에 대한 안내에 대하여 고객이 동의를 선택한
        후 `&quot;`동의`&quot;` 버튼을 누르면 약관에 동의하는 것으로 간주됩니다.
      </Text>
      <Text style={styles.top}>
        2. 이용 계약은 고객의 이용 신청에 대하여 회사의 승낙이 고객의 컴퓨터에 입력된 때에
        성립합니다.
      </Text>
      <Text style={styles.title}>제 6 조(이용 신청)</Text>
      <Text style={styles.top}>
        이용 신청은 서비스의 이용자 등록 화면에서 고객이 다음 사항을 가입신청 양식에 기록하는
        방식으로 행합니다.
      </Text>
      ...
      <Text style={styles.top}>
        회원은 이용 신청 시 기재한 사항이 변경되었을 경우 회사가 정한 별도의 이용 방법으로 정해진
        양식 및 방법에 의하여 수정하여야 합니다.
      </Text>
      <Text style={styles.title}>제3장 서비스 이용</Text>
      ...
      <Text style={styles.top}>
        ...
        이유로 서비스가 일지 중지될 수 있고, 또한 운영상의 목적으로 회사가 정한 기간 동안에는
        서비스가 일시 중지될 수 있습니다. 이러한 경우 회사는 사전 또는 사후에 이를 공지합니다.
      </Text>
      <Text style={styles.top}>
        2. 회사는 서비스를 일정범위로 분할하여 각 범위별로 이용 가능한 시간을 별도로 정할 수 있으며
        이 경우 그 내용을 공지합니다.
      </Text>
      ...
      <Text style={styles.top}>
        2. 회사는 다음 각 호에 해당하는 경우 서비스의 전부 또는 일부를 제한하거나 중지할 수
        있습니다.
      </Text>
      ...
      <Text style={styles.top}>
        (4) 서비스 제공업자와의 계약 종료 등과 같은 회사의 제반 사정으로 서비스를 유지할 수 없는
        경우
      </Text>
      <Text style={styles.top}>(5) 기타 천재지변, 국가비상사태 등 불가항력적 사유가 있는 경우</Text>
      <Text style={styles.top}>
        3. 제2항에 의한 서비스 중단의 경우에는 회사가 제20조 제2항에서 정한 방법으로 이용자에게
        통지합니다. 다만, 회사가 통제할 수 없는 사유로 인한 서비스의 중단 (운영자의 고의, 과실이
        없는 디스크 장애, 시스템 다운 등)으로 인하여 사전 통지가 불가능한 경우에는 사후에 통지할 수
        있습니다.
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        ...
        참여하는 등의 방법으로 교신 또는 거래를 하는 것은 전적으로 회원과 광고주 간의 문제입니다.
      ...
      <Text style={styles.top}>
        1. 회사는 회원이 게시하거나 전달하는 서비스 내의 모든 내용물(회원간 전달 포함)이 다음 각
        호의 경우에 해당한다고 판단되는 경우 사전통지 없이 삭제할 수 있으며, 이에 대해 회사는 어떠한
        책임도 지지 않습니다.
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        ...
        등록한 컨텐츠)에 대한 자동 삭제되지 않으므로 삭제를 원하는 경우 탈퇴 이전에 삭제하여야
        합니다.
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        1. 회원이 게시한 게시물은 다음 각 호의 목적에 한하여 회사가 이용할 수 있으며, 이는
        이용계약이 해지된 이후에도 지속적으로 이용할 수 있습니다.
      </Text>
      ...
      <Text style={styles.top}>
        2. 회사는 회원 또는 이해관계가 있는 제3자로부터 게시물의 검색결과 노출 중단, 삭제, 비공개
        조치 등의 명시적 요청이 있을 경우에는 그에 따른 조치를 합니다.
      </Text>
      <Text style={styles.top}>
        3. 회사가 제1항 이외의 목적으로 회원의 게시물을 이용하고자 하는 경우에는 전화, 팩스,
        전자우편 등을 통해 사전에 회원의 동의를 얻습니다.
      </Text>
      <Text style={styles.top}>
        4. 회사는 회원이 서비스 내에 게시한 게시물이 타인의 저작권, 프로그램 저작권 등을
        침해하더라도 이에 대한 민,형사상의 책임을 부담하지 않습니다. 만일 회원이 타인의 저작권,
        프로그램 저작권 등을 침해하였음을 이유로 회사가 타인으로부터 손해배상청구 등 이의 제기를
        받은 경우 회원은 회사의 면책을 위하여 노력하여야 하며, 회사가 면책되지 못한 경우 회원은 그로
      ...
      <Text style={styles.top}>
        ...
        서비스상품에 따라 별도의 약관이 존재할 수 있으며, 이용약관과 각 개별 약관의 내용이 상충될
        경우 각 개별 약관이 우선됩니다.
      </Text>
      <Text style={styles.title}>제 4 장 계약당사자의 의무</Text>
      <Text style={styles.title}>제 17 조(회사의 의무)</Text>
      <Text style={styles.top}>
        1. 회사는 서비스 제공과 관련하여 알고 있는 회원의 신상정보를 본인의 승낙 없이 제3자에게
        누설, 배포하지 않습니다. 단, 관계법령에 의한 수사상의 목적으로 관계기관으로부터 요구 받은
        경우나 방송통신심의위원회의 요청이 있는 경우 등 법률의 규정에 따른 적법한 절차에 의한
        경우에는 그러하지 않습니다.
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        ...
        신속한 처리가 곤란한 경우 그 사유와 처리 일정을 서비스 화면에 게재하거나 e-mail(전자우편)
        등을 통하여 회원에게 통지합니다.
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        (1) 이용 신청 또는 변경 시 허위 사실을 기재하거나, 다른 회원의 아이디(ID) 및 비밀번호를
        도용, 부정하게 사용하는 행위
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        (17) 회사의 직원이나 운영자를 가장하거나 사칭하여 또는 타인의 명의를 도용하여 글을
        게시하거나 메일을 발송하는 행위
      </Text>
      <Text style={styles.top}>
        (18) 컴퓨터 소프트웨어, 하드웨어, 전기통신 장비의 정상적인 가동을 방해, 파괴할 목적으로
        고안된 소프트웨어 바이러스, 기타 다른 컴퓨터 코드, 파일, 프로그램을 포함하고 있는 자료를
        게시하거나 e-mail(전자우편)으로 발송하는 행위
      </Text>
      ...
      <Text style={styles.top}>
        3. 회원은 회사에서 공식적으로 인정한 경우를 제외하고는 서비스를 이용하여 상품을 판매하는
        영업 활동을 할 수 없으며 특히 해킹, 광고를 통한 수익, 음란사이트를 통한 상업행위,
        상용소프트웨어 불법배포 등을 할 수 없습니다. 이를 위반하여 발생한 영업 활동의 결과 및 손실,
        관계기관에 의한 구속 등 법적 조치 등에 관해서는 회사가 책임을 지지 않으며, 회원은 이와 같은
      ...
      <Text style={styles.top}>
        5. 회원은 등록정보에 변경사항이 발생할 경우 즉시 갱신하여야 합니다. 회원이 제공한 등록정보
        및 갱신한 등록정보가 부정확할 경우, 기타 회원이 본 조 제1항에 명시된 행위를 한 경우에 회사는
        본 약관 제23조에 의해 회원의 서비스 이용을 제한 또는 중지 할 수 있습니다.
      </Text>
      ...
      <Text style={styles.top}>
        1. 회원에 대한 통지를 하는 경우 회사는 회원이 등록한 e-mail(전자우편) 주소 또는 SMS 등
        기타의 방법으로 회원에게 이를 통지 할 수 있습니다.
      </Text>
      <Text style={styles.top}>
        2. 회사는 불특정 다수 회원에 대한 통지의 경우 서비스 공지게시판 등에 게시함으로써 개별
        통지에 갈음할 수 있습니다.
      </Text>
      <Text style={styles.title}>제 21 조(이용자의 개인정보보호)</Text>
      <Text style={styles.top}>
        회사는 관련법령이 정하는 바에 따라서 회원 등록정보를 포함한 회원의 개인정보를 보호하기
        위하여 노력합니다. 회원의 개인정보보호에 관해서는 관련법령 및 회사가 정하는
      ...
      <Text style={styles.top}>
        1. 회원이 서비스 이용계약을 해지하고자 할 경우에는 본인이 웹사이트 상에서 또는 전화,
        전자우편, 모사전송 등 회사가 정한 별도의 이용방법으로 회사에 해지신청을 하여야 합니다.
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        3. 회원이 이용계약을 해지하고자 하는 경우에는 회원 본인이 이용계약 해지신청(회원탈퇴)을
        하여야 합니다. 이용해지 신청은 [정보관리{'>'}개인정보관리{'>'}회원탈퇴]를 통하여 언제든지 할
        수 있습니다.
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        5. 회사는 `&apos;`정보통신망이용촉진 및 정보보호 등에 관한 법률`&apos;` 및 동법 시행령에
        따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 보호하기 위해 개인정보 파기 등 필요한
        조치를 취합니다.
      </Text>
      <Text style={styles.top}>
        6. 회사는 객관적으로 계정정보 도용 피해가 우려되는 경우 또는 회원이 계속해서 1년 이상
        로그인하지 않을 경우에는 회원정보의 보호 및 운영의 효율성을 위해 임시조치, 이용제한,
      ...
      <Text style={styles.top}>
        7. 본 조 제2항 및 제4항, 제5항의 회사 조치에 대하여 회원은 회사가 정한 절차에 따라 이의
        신청을 할 수 있습니다.
      </Text>
      <Text style={styles.top}>
      ...
      <Text style={styles.top}>
        ...
        사이트에 게재한 정보 • 자료 • 사실의 신뢰도 및 정확성 등 내용에 대하여는 책임을 지지
        않습니다.
      </Text>
      <Text style={styles.top}>
        4. 회사는 회원 상호간 또는 회원과 제3자 상호간에 서비스를 매개로 발생한 분쟁에 대해서는
      ...
      <Text style={styles.footer}>(시행일) 본 약관은 2021년 6월 7일부터 시행합니다.</Text>
    </ScrollView>
  );
}
