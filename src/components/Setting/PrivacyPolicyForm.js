...
const PrivacyPolicyForm = () => (
  <View style={{ margin: 20 * tmpWidth }}>
    ...
    <Text style={{ fontWeight: '600', marginTop: 6 * tmpWidth }}>
    ...
    <Text>
      신규 서비스(제품) 개발 및 맞춤 서비스 제공, 인구통계학적 특성에 따른 서비스 제공 및 광고 게재
      , 서비스의 유효성 확인 등을 목적으로 개인정보를 처리합니다.
    </Text>
    <Text style={styles.title}>제2조(개인정보의 처리 및 보유 기간)</Text>
    <Text style={styles.top}>
      ① 음파는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은
    ...
    <Text style={styles.top}>
      ① 정보주체는 음파에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수
      있습니다.
    </Text>
    <Text style={styles.top}>
      ② 제1항에 따른 권리 행사는 음파에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면,
      전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 음파는 이에 대해 지체 없이 조치하겠습니다.
    </Text>
    <Text style={styles.top}>
    ...
    <Text style={styles.top}>
      ⑥ 음파는 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를
    ...
    <Text style={styles.top}>
      ② 정보주체께서는 음파의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의,
      불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.
      음파는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
    </Text>
