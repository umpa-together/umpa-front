...
export default SelectedStory = () => {
    ...
    const { storyModal, onClose, onClickProfile, currentStory, onClickStory, setIsMyStory, isMyStory } = useStory()
    ...
    useEffect(() => {
        if(selectedStory){
            ...
            setIsMyStory(selectedStory.song.song ? false : true)
        ...
        >
            <View style={styles.flex}>
                ...
                <View style={[styles.flexRow, styles.flex]}>
                    <TouchableOpacity
                        style={styles.flex}
                        onPress={onClickPrevStory}
                    />
                    <TouchableOpacity
                        style={styles.flex}
                        onPress={onClickNextStory}
                    />
                </View> }
