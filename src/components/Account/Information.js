  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.flexRow}>
        <TouchableOpacity style={styles.flexRow} onPress={onClickFollowing}>
          <Text style={styles.follow}>팔로잉</Text>
          <Text style={styles.number}>{following.length}</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.flexRow} onPress={onClickFollower}>
          <Text style={styles.follow}>팔로워</Text>
          <Text style={styles.number}>
            {followerNum !== undefined ? followerNum : follower.length}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
