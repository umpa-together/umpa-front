    ...
    return (
        ...
        >
            <View style={isMyAccount ? styles.myContainer : styles.otherContainer}>
                ...
                <View>
                    <StoryViewer viewerModal={viewerModal} setViewerModal={setViewerModal} setStoryModal={setStoryModal} />
                    ...
                    <View style={{alignItems: 'center'}}>
                        ...
                        <View style={styles.artistBox}>
                            <Text style={styles.artist} numberOfLines={1}>{story.song.attributes.artistName}</Text>
                        </View>
                    </View>
                    { isMyAccount && 
                    <TouchableOpacity 
                    ...
                    { deleteModal && <DeleteModal deleteModal={deleteModal} setDeleteModal={setDeleteModal} type={'todaySong'} /> }
                </View> }
            </View>
        </Modal>
    )
