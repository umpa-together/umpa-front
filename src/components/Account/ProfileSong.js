...
export default ProfileSong = ({ song, isMyAccount }) => {
    ...
    return (
        <>
            ...
            <RepresentSong representModal={representModal} setRepresentModal={setRepresentModal} song={song} myAccount={isMyAccount}/>
        </>
    )
}
