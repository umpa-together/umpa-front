...
const Header = ({ user, isMyAccount }) => {
  ...
  return (
    <View style={styles.container}>
      {isMyAccount ? (
        <>
          <TouchableOpacity style={[styles.musicBox, styles.size]} onPress={onClickMusicBox}>
            <SvgUri source={require('assets/icons/musicBox.svg')} />
          </TouchableOpacity>
          <TouchableOpacity style={[styles.setting, styles.size]} onPress={onClickSetting}>
            <SvgUri source={require('assets/icons/setting.svg')} />
          </TouchableOpacity>
          {musicBoxModal && (
            <MusicBoxModal musicBoxModal={musicBoxModal} setMusicBoxModal={setMusicBoxModal} />
          )}
        </>
      ) : (
        <>
          <TouchableOpacity style={[styles.back, styles.size]} onPress={onClickBack}>
            <SvgUri source={require('assets/icons/back.svg')} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.report} onPress={onClickReport}>
